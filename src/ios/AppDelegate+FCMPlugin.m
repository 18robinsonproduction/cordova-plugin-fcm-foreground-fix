...
didReceiveNotificationResponse:(UNNotificationResponse *)response
    ...
    // check to show notification when app forceground
    UIApplication *application;
    NSLog(@"Application state: %ld", application.applicationState);
    NSLog(@"APP state appInForeground: %@" , [FCMPlugin.fcmPlugin appInForeground] ? @"YES" : @"NO");
    if ([FCMPlugin.fcmPlugin appInForeground] == YES) {
        NSLog(@"APP state foreground");
